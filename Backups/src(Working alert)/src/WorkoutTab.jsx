...
export default function WorkoutTab() {
  ...
  const cardioExercises = ['Running', 'Cycling', 'Rowing', 'Jump Rope', 'Swimming', 'Stairmaster'];
      ...
      <div className="absolute left-0 top-6 bg-gray-800 border border-gray-700 p-2 rounded shadow z-30 w-32">
        {['Warm-Up', 'Drop Set', 'Failure', ''].map((tagOption) => (
          ...
          <button
            ...
            className="w-full bg-green-600 hover:bg-green-700 py-3 rounded text-lg font-bold mb-2"
          >
            Finish Workout
          </button>
